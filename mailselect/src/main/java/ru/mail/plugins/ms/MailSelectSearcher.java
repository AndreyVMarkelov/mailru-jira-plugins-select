    ...
    implements CustomFieldStattable
{
    ...
    public void init(CustomField field)
    {
        ...
        searchInputTransformer = new MailRuSelectSearchInputTransformer(
            customField.getId(),
            clauseNames,
            field,
            jqlOperandResolver,
        ...
        searchRenderer = new MailRuSelectCustomFieldRenderer(
            clauseNames,
            getDescriptor(),
            customField,
            new MailRuSelectCustomFieldValueProvider(),
